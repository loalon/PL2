...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu May 04 12:27:10 CEST 2017
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
          ...
          case 76: // bloqueSent ::= OBRACE NT$2 tiposLocales variablesLocales sentLocales CBRACE 
            {
              ...
              // propagate RESULT from NT$2
                RESULT = (BloqueSent) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
	...
	cb.addQuadruple("CALLB", fun);
	cb.addQuadruples(var.getIntermediateCode());
	cb.addQuadruples(sen.getIntermediateCode());
	
	cb.addQuadruple("CALLC", fun);
